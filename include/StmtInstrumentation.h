...
public:
  ...
  bool VisitFunctionBodyCompoundStmtForPrint(const clang::CompoundStmt* cs);
  bool VisitStmtForPrint(const clang::Stmt* stmt);
  ...
  void PrintStartAndEndLineNumbers(const clang::Stmt* stmt, std::string type);
